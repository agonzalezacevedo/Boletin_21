...
public class Metodos {
    ...
    public Libro pedirDatos() {
        Libro lib = new Libro(
                JOptionPane.showInputDialog("Introduce o titulo"),
    ...
    public void borrar(ArrayList<Libro> lista, File fich) {
        try {
            sc = new Scanner(fich).useDelimiter(",\\s*");
            while (sc.hasNextLine()) {
    ...
    public void actualizar(String nomeFich, ArrayList<Libro> lista) {
        try {
    ...
    public void cambioPrezo(ArrayList<Libro> lista) {
        String titulo = pedirConsulta();
